...
<template>
  ...
  <div v-if="todos.length == 0">vous n'avez de post </div>
  ...
  <div class="flex items-center">
    ...
    <h3 class="text-lg font-medium">post it </h3>
  </div>
...
<div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
  <div class="flex items-center">
    ...
    <span class="sr-only">Info</span>
    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-300">post it</h3>
  </div>

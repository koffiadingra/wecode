...
function SearchMoviesIMDBForm({ onClose }) {
  ...
  return (
    <div className="mt-4 px-6 py-4 bg-white rounded-lg shadow-md max-h-[500px] overflow-auto">
      <div className="flex justify-between">
        <h1 className="text-2xl font-semibold text-blue-800">IMDB</h1>
        ...
        <div className="grid gap-4">
          {results.description.map((movie, index) => (
            <div key={index} className="bg-blue-200 p-4 rounded-lg shadow">
              ...
              <p>
                <a className="underline text-lg" href={movie["#IMDB_URL"]}>
                  Voir sur IMDB
                </a>
              </p>
            </div>
...
export default SearchMoviesIMDBForm;

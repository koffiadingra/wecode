...
const PLAYERSAPI_KEY="a01a76f5d9msh4931b4605af7be7p117babjsnc6eca93d52da"
const PLAYERSAPI_URL="https://anime-db.p.rapidapi.com/anime?page=1&size=1"


export default function PlayerApp({onClose}){
...
//     async function loaderinfo(search="Death Note") {
//     try {
//     const url = `${PLAYERSAPI_URL}&search=${search}`;
//     const options = {
//       method: "GET",
//       headers: {
//         "x-rapidapi-key": PLAYERSAPI_KEY,
//       },
//     };
...
async function loaderinfo(search="Death Note") {
  try {
    ...
    setTimeout(() => {
      // Ici on passe seulement data qui est un tableau de joueurs
      setPlayer(data.data); 
    }, 2000);

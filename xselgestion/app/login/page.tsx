      ...
      <div className="w-1/2 flex flex-col items-center justify-center h-screen gap-5">
        ...
        <div>
          <div className="text-center mb-10">
            <h1 className="text-2xl font-bold text-teal-500">AUTHENTIFICATION</h1>
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="email" className="text-teal-500">Adresse mail</label>
              <input
                type="email"
                id="email"
            ...
            <div className="relative">
              <label htmlFor="password" className="block mb-2 text-teal-500">
                Mot de passe
              </label>
              <input
            ...
            <div className="flex gap-10 items-center justify-between mb-10">
              <div>
                ...
                />
                <label htmlFor="remember" className="ml-2 text-teal-500">
                  Se souvenir de moi
                </label>
              </div>
              <div>

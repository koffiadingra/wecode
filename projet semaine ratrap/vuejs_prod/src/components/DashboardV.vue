      ...
      <div class="p-6 border-b border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <form @submit.prevent="saveContact">
            <input type="text" v-model="currentContact.name" placeholder="Nom">
            <input type="text" v-model="currentContact.phone" placeholder="Téléphone">
            <input type="text" v-model="currentContact.email" placeholder="email">
            <button type="submit">
              {{ editingIndex === -1 ? 'Ajouter' : 'Mettre à jour' }}
            </button>
          </form>
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-4">
          <div class="relative flex-grow">
            ...
            <input type="text" class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg w-full " placeholder="magnet link...">
          </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr v-for="(contact, index) in contacts" :key="index" class="hover:bg-gray-50 transition-colors duration-150">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <button @click="editContact(contact, index)">
                  Edit
                </button>
              </td>
  ...
  methods: {
    saveContact() {
      if (this.editingIndex === -1) {
        ...
        this.contacts[this.editingIndex] = { ...this.currentContact };
      }
      this.resetForm();
    },

    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
      ...
      <form @submit.prevent="onLogin">
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="email" name="email" type="email" autocomplete="email" required
                ...
                v-model="credentials.email" placeholder="Email" />
            </div>
          </div>
          ...
          <!-- Submit Button -->
          <div>
            <button type="submit" :disabled="authStore.isLoading" @click="onLogin"
              class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              {{ authStore.isLoading ? 'connection...' : 'Sign in' }}
            </button>
          </div>
        </div>
      </form>
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600">
          ...
          <button  href="#" class="font-medium text-blue-600 hover:text-blue-500">Sign up</button>
        </p>
      </div>
    </div>
  </div>
